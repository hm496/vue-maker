...
module.exports = {
  ...
  resolve: {
    ...
    alias: Object.assign({
      ...
      // unfortunate to rely on, as vue-maker could be symlinked,
      // and thus babel-runtime might not be resolvable from the source.
      'babel-runtime': path.dirname(
        require.resolve('babel-runtime/package.json')
      ),
      'fetch-jsonp': path.dirname(
        require.resolve('fetch-jsonp/package.json')
      ),
      'object-assign': path.dirname(
        require.resolve('object-assign/package.json')
      ),
      'vue': path.dirname(
        require.resolve('vue/package.json')
      ),
      'vue-router': path.dirname(
        require.resolve('vue-router/package.json')
      ),
      'vuex': path.dirname(
        require.resolve('vuex/package.json')
      ),
      'vuex-router-sync': path.dirname(
        require.resolve('vuex-router-sync/package.json')
      ),
      'alloyfinger': path.dirname(
      ...
      },
      {
        ...
        oneOf: [
          ...
          // that fall through the other loaders.
          {
            ...
            exclude: [/\.(js|jsx|mjs|vue|less|scss)$/, /\.html$/, /\.json$/],
            options: {
              name: 'static/media/[name].[hash:8].[ext]',
            },
          },
